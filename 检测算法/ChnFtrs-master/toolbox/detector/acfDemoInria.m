...
opts=acfTrain(); opts.modelDs=[36 80]; opts.modelDsPad=[36 80];
opts.posGtDir=[dataDir 'train\posGt1109']; opts.nWeak=[32 128 512 2048];
opts.posImgDir=[dataDir 'train\pos1109']; opts.pJitter=struct('flip',1);
opts.negImgDir=[dataDir 'train\neg']; opts.pBoost.pTree.fracFtrs=1/16;
...
detector = acfModify(detector,'cascThr',-49,'cascCal',0.05);
