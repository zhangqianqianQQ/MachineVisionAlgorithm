classdef RegionToPixelSoft < dagnn.Layer
    ...
    properties
        decay % has to be set once before usage, 0: max-pooling, 1: avg-pooling
    end
    ...
    methods
        function outputs = forward(obj, inputs, params) %#ok<INUSD>
            ...
            assert(~isempty(obj.decay));
            
            [scoresSP, obj.mask] = regionToPixelSoft_forward(scoresAll, overlapListAll, obj.decay);
        ...
        function obj = RegionToPixelSoft(varargin)
            obj.load(varargin);
        end
    end
end