...
function compile_windows
    ...
    if strcmp(computer,'PCWIN64')
        % mex  -DMATLAB -DWIN64 -output mexClassRF_train   src/classRF.cpp src/classTree2.cpp src/cokus.cpp precompiled_rfsub/win64/rfsub.o src/mex_ClassificationRF_train.cpp   src/rfutils.cpp 
