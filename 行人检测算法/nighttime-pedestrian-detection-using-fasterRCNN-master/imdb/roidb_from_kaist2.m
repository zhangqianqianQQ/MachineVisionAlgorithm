function roidb = roidb_from_kaist2(root, imdb, pLoad)
...
if(strcmp(imdb.name,'train'))
    anno_path = fullfile(root,imdb.name,'kaist','annotations');
else
    anno_path = fullfile(root,imdb.name,'annotations');
end
