...
% Prepare the data
% -------------------------------------------------------------------------
imdb = my_extract_patches(100, 0.8);
...
trainOpts.expDir = 'data/grey-classification-experiment/' ;
...
save('data/grey-classification-experiment/cnn.mat', '-struct', 'net') ;
...
net = load('data/grey-classification-experiment/cnn.mat') ;
