function lightfield_resnet_fusion(varargin)
...
doMax = 0;
nFrames = 3;
opts.train.learningRate =  1*[1e-3*ones(1,2) 1e-4*ones(1,2)  1e-5*ones(1,1) 1e-6*ones(1,1)]  ;
opts.train.cheapResize = 0 ;

opts = vl_argparse(opts, varargin) ;

[opts, varargin] = vl_argparse(opts, varargin) ;
model = ['lightfield-method7-res50-relu5-2x-resnet-split=' num2str(opts.nSplit) '-vgg-' opts.initMethod '-pred-3D=' num2str(addConv3D) ...
...
% opts.train.fusionLayer = {'relu_fusion_1', 'relu_fusion_1'; };
opts.train.fusionLayer = {'res5c_relu', 'res5c_relu'; };
...
opts.train.backpropDepth = cell(8,1);
% opts.train.backpropDepth = ['res5c_relu_spatial_temporal';'res5c_relu_spatial_temporal';'res5c_relu_spatial_temporal';'res5c_relu_spatial_temporal';'res5c_relu_spatial_temporal';];'res5c_relu_temporal';'res5c_relu_temporal';'res5c_relu_temporal';
 opts.train.backpropDepth(1:6) = {'res5c_relu_temporal'};
%  opts.train.backpropDepth(6:8)= {'res3d_relu_temporal'};
 %;['relu_fusion_1_temporal';'relu_fusion_1_temporal';'relu_fusion_1_temporal';'res5c_relu_temporal';'res5c_relu_temporal';'res5c_relu_temporal'];'res3d_relu_temporal';'res3d_relu_temporal';'conv1_relu_temporal'
