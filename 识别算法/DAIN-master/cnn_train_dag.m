...
% dain_predict=zeros(1,numel(subset));
% dain_label=zeros(1,numel(subset));
% count=1;
...
%       [bestScore, best] = max(gather(frame_predictions)) ;
%       dain_predict(count)=best;
%       dain_label(count)=inputs{4};
%       count=count+1;
